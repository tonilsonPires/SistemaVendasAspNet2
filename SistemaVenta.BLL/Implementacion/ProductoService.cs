...
namespace SistemaVenta.BLL.Implementacion
{
  public class ProductoService : IProductoService
  {
    ...
    public async Task<Producto> Editar(Producto entidad, Stream imagen = null, string nombreImagen = "")
    {
      ...
      if(productoExiste != null)
        throw new TaskCanceledException("O código de barras já está atribuído a outro produto");
      ...
      try
      {
        ...
        if(!respuesta)
          throw new TaskCanceledException("Não foi possível alterar o produto");
