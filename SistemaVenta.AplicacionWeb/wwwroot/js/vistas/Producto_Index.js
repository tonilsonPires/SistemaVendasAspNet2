    ...
    fetch("/Producto/Crear", {
      ...
      .then(responseJson => {
        if (responseJson.estado) {
          ...
          swal("Resultado!", "Produto criado com sucesso", "success")
        } else {
    ...
    fetch("/Producto/Editar", {
      ...
      .then(responseJson => {
        if (responseJson.estado) {
          ...
          $("#modalData").modal("hide")
          swal("Resultado!", "Produto alterado com sucesso", "success")
        } else {
          swal("Lamentamos", responseJson.mensaje, "error")
        }
      })
        ...
        fetch(`/Producto/Eliminar?idProducto=${data.idProducto}`, {
          ...
          .then(responseJson => {
            if (responseJson.estado) {
              ...
              swal("Resultado!", "Produto eliminado com sucesso", "success")
            } else {
              swal("Lamentamos", responseJson.mensaje, "error")
            }
          })
