...
$("#btnGuardar").click(function () {
  ...
  if ($("#txtDescripcion").val().trim() == "") {
    toastr.warning("", "Deves completar os campos : descripcion")
    ...
    fetch("/Categoria/Crear", {
      ...
      .then(responseJson => {
        if (responseJson.estado) {
          ...
          swal("Resultado!", "Categoria criada com sucesso", "success")
        } else {
    ...
    fetch("/Categoria/Editar", {
      ...
      .then(responseJson => {
        if (responseJson.estado) {
          ...
          $("#modalData").modal("hide")
          swal("Resultado!", "Categoria alterada com sucesso", "success")
        } else {
          swal("Lamentamos", responseJson.mensaje, "error")
        }
      })
